...
(function () {
  ...
  const STORIES = [
    {
      ...
      name: "Fatima El Amrani", role: "Community organizer",
      neighborhood: "Afrikaanderwijk", date: "14 MAR 2026", image: IMG("interior-1.jpg"),
    ...
    },
    {
      ...
      name: "Thomas Dijkstra", role: "Harbour electrician",
      neighborhood: "Delfshaven", date: "09 MAR 2026", image: IMG("hero.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
    ...
    },
    {
      ...
      name: "Sanne Bakker", role: "Baker",
      neighborhood: "Nieuwe Binnenweg", date: "02 MAR 2026", image: IMG("shop-1.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
    ...
    },
    {
      ...
      name: "Joran Visser", role: "Bus driver",
      neighborhood: "Noord", date: "24 FEB 2026", image: IMG("interior-2.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
    ...
    },
    {
      ...
      name: "Amira Haddad", role: "Nurse",
      neighborhood: "Blijdorp", date: "17 FEB 2026", image: IMG("shop-2.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
    ...
    },
    {
      ...
      name: "Wesley Boateng", role: "Football coach",
      neighborhood: "Rotterdam West", date: "10 FEB 2026", image: IMG("interior-3.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
    ...
    },
    {
      ...
      name: "Lieke de Wit", role: "Bookshop owner",
      neighborhood: "Nieuwe Binnenweg", date: "03 FEB 2026", image: IMG("shop-3.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
    ...
    },
    {
      ...
      name: "Mehmet Yılmaz", role: "Greengrocer",
      neighborhood: "Afrikaanderwijk", date: "27 JAN 2026", image: IMG("interior-4.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
    ...
    // upcoming — submitted, not yet recorded
    {
      ...
      name: "In the chair soon", role: "Maker",
      neighborhood: "Noord", date: "Recording in April", image: IMG("interior-2.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
      answer: "",
    },
    {
      id: 10, number: 25, status: "upcoming",
      name: "In the chair soon", role: "Volunteer",
      neighborhood: "Delfshaven", date: "Recording in April", image: IMG("shop-1.jpg"),
      question: "What did this city teach you that nobody sat you down to explain?",
      answer: "",
    },
  ];
  ...
  window.CT_DATA = { NEIGHBORHOODS, STORIES, SEED_REFLECTIONS, TARGET, collected };
})();
