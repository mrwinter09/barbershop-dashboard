...
export const translations = {
  en: {
    ...
    home_hero: "50 Conversations. One City.",
    ...
    about_step2_body: "You sit down for a real haircut. While the clippers run, there's one question, and time to actually answer it.",
  ...
  nl: {
    ...
    home_hero: "50 Gesprekken. Één Stad.",
    ...
    about_step2_body: "Je gaat zitten voor een echte knipbeurt. Terwijl de tondeuse loopt, is er één vraag, en tijd om hem echt te beantwoorden.",
